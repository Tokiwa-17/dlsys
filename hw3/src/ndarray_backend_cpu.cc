...
void ScalarMul(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be the multiplication of corresponding entry in a plus the scalar val.
   */
  for (size_t i = 0; i < a.size; i++) {
    out->ptr[i] = a.ptr[i] * val;
  }
...
void ScalarPower(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be the Power of corresponding entry in
   */
  for (size_t i = 0; i < a.size; i++) {
...
void EwiseMaximum(const AlignedArray& a, const AlignedArray& b, AlignedArray *out) {
  /**
   * Set entries in out to be the maximum of corresponding entry in a and b.
   */
  for (size_t i = 0; i < a.size; i++) {
...
void ScalarMaximum(const AlignedArray& a, scalar_t val, AlignedArray *out) {
  /**
   * Set entries in out to be the maximum of corresponding entry in a and val
   */
  for (size_t i = 0; i < a.size; i++) {
